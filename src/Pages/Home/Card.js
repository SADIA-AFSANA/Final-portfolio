            ...
            <div className='py-10 grid grid-cols-1 lg:grid-cols-3'>
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p><button className='btn h-14 bg-gradient-to-r from-sky-300 to-indigo-400'><Link to='/first'>More Details</Link></button></p>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p><button className='btn h-14 bg-gradient-to-r from-sky-300 to-indigo-400'><Link to='/second'>More Details</Link></button></p>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p><button className='btn h-14 bg-gradient-to-r from-sky-300 to-indigo-400'><Link to='/third'>More Details</Link></button></p>
                    </div>
                </div>
            </div>
        </div>
